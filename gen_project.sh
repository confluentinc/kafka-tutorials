...
KSQL_DB_VERSION_RPL="<KSQLDB-VERSION>"
...
function do_replacements() {
    ...
    echo "Setting KSQL-DB version"
    grep -Rl ${KSQL_DB_VERSION_RPL} ${WORK_DIR} | xargs sed -i '.orig' "s/${KSQL_DB_VERSION_RPL}/${KSQLDB_VERSION}/g"
