...
public class <MAIN-CLASS>Test {
    ...
    public void testJoin() throws IOException {
        ...
        try (final TopologyTestDriver testDriver = new TopologyTestDriver(topology, streamProps)) {
            ...
            final Serde<Long> longAvroSerde = <MAIN-CLASS>.<Long>getPrimitiveAvroSerde(envProps, true);
            final SpecificAvroSerde<Example> exampleAvroSerde = <MAIN-CLASS>.<Example>getSpecificAvroSerde(envProps);
