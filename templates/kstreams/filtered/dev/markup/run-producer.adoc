...
+++++
<pre class="snippet"><code class="shell">{% include_raw tutorials/<TUTORIAL-SHORT-NAME>/kstreams/code/tutorial-steps/dev/console-producer.sh %}</code></pre>
+++++
...
+++++
<pre class="snippet"><code class="json">{% include_raw tutorials/<TUTORIAL-SHORT-NAME>/kstreams/code/tutorial-steps/dev/example-input.json %}</code></pre>
+++++
