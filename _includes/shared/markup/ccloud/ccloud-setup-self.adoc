The quickest way to get started with Apache Kafka is on https://www.confluent.io/confluent-cloud/tryfree/[Confluent Cloud], which provides it as a fully managed service.
