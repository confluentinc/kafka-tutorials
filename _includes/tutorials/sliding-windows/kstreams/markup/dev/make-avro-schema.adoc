...
Then create the following Avro schema file at `src/main/avro/temperatue_reading.avsc` for our `TemperatureReading` object:

+++++
<pre class="snippet"><code class="avro">{% include_raw tutorials/sliding-windows/kstreams/code/src/main/avro/temperatue_reading.avsc %}</code></pre>
+++++
