...
public class AbstractFlinkKafkaTest {
  ...
  protected Integer schemaRegistryPort, kafkaPort;
  ...
  protected static String tableauResults(TableResult tableResult) {
    ...
    // on called to this method, we kick off a thread to kill the underlying job in 5 seconds.
    //
    ...
    new Thread(() -> {
      try {
        ...
        // do nothing; proceed with job cancellation
      }
