Create the following Gradle build file, named `build.gradle`, in the `aggregate-minmax` directory.

+++++
<pre class="snippet"><code class="groovy">{% include_raw tutorials/aggregating-minmax/flinksql/code/build.gradle %}</code></pre>
+++++
