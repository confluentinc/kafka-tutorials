...
Create the following file at `src/test/resources/create-shipments.sql.template`. Note the `KAFKA_PORT` placeholder in this file. Out test will dynamically assign these to the ports that Testcontainers assigns.
