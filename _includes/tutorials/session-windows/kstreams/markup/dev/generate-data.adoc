...
Now create the following Avro schema file `datagen-temperature-reading.avsc` in the current working directory (`session-windows`) for the tutorial:

+++++
<pre class="snippet"><code class="avro">{% include_raw tutorials/session-windows/kstreams/code/datagen-temperature-reading.avsc %}</code></pre>
+++++
...
+++++
<pre class="snippet"><code class="shell">{% include_raw tutorials/session-windows/kstreams/code/tutorial-steps/dev/create-connector.sh %}</code></pre>
+++++
