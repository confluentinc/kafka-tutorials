////
  ...
  _includes/tutorials/session-windows/kstreams/code/src/main/avro.
...
+++++
<pre class="snippet"><code class="avro">{% include_raw tutorials/session-windows/kstreams/code/src/main/avro/clicks.avsc %}</code></pre>
+++++
