////
  ...
  _includes/tutorials/naming-changelog-repartition-topics/kstreams/code/src/main/avro.
...
+++++
<pre class="snippet"><code class="avro">{% include_raw tutorials/naming-changelog-repartition-topics/kstreams/code/src/main/avro/example.avsc %}</code></pre>
+++++
