...
+++++
<pre class="snippet"><code class="java">{% include_raw tutorials/spring-kafka-error-handling/kafka/code/src/test/java/io/confluent/developer/SpringbootApplicationTests.java %}</code></pre>
+++++
