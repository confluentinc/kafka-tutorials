...
+++++
<pre class="snippet"><code class="java">{% include_raw tutorials/spring-kafka-error-handling/kafka/code/src/main/java/io/confluent/developer/SpringBootApp.java %}</code></pre>
+++++
