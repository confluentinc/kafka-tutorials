////
  ...
  _includes/tutorials/spring-kafka-error-handling/kafka/code/src/main/avro.
...
+++++
<pre class="snippet"><code class="avro">{% include_raw tutorials/spring-kafka-error-handling/kafka/code/src/main/avro/example.avsc %}</code></pre>
+++++
