...
+++++
<pre class="snippet"><code class="shell">{% include_raw tutorials/spring-kafka-error-handling/kafka/code/tutorial-steps/dev/console-producer.sh %}</code></pre>
+++++
...
+++++
<pre class="snippet"><code class="json">{% include_raw tutorials/spring-kafka-error-handling/kafka/code/tutorial-steps/dev/example-input.json %}</code></pre>
+++++
