////
  ...
  _includes/tutorials/streams-to-table/kstreams/code/src/main/avro.
...
+++++
<pre class="snippet"><code class="avro">{% include_raw tutorials/streams-to-table/kstreams/code/src/main/avro/example.avsc %}</code></pre>
+++++
