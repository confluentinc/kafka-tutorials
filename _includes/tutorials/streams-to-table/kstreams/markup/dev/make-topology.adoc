...
The rest of this Kafka Streams appliction simply writes the incoming records back out to a topic.  In the subsequent tutorial steps you'll use a console consumer to observe the differences between a record stream and a changelog stream.
