Create the following Gradle build file, named `build.gradle`, in the `cumulating-windows` directory.

+++++
<pre class="snippet"><code class="groovy">{% include_raw tutorials/cumulating-windows/flinksql/code/build.gradle %}</code></pre>
+++++
