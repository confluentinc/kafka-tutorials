In the first consumer example, you observed all incoming records becuase the conusmer was already running, waiting for incoming records.
...
+++++
<pre class="snippet"><code class="shell">{% include_raw tutorials/console-consumer-primitive-keys-values/kafka/code/tutorial-steps/dev/input-step-two.txt %}</code></pre>
+++++
