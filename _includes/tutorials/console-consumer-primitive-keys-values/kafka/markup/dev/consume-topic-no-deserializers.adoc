...
Your focus here is the reading values on the command line with the console consumer.  
...
Close the consumer with a kbd:[Ctrl + C] command, but keep the container shell open.