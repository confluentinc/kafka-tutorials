...
+++++
<pre class="snippet"><code class="java">{% include_raw tutorials/connect-sink-timestamp/ksql/code/src/main/java/io/confluent/developer/KafkaProducerDevice.java %}</code></pre>
+++++
