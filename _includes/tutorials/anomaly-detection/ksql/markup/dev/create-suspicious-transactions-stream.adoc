...
====
*Things to note:* +
- ksqlDB only supports inner and left joins between a stream and a table. See link:/tutorials/join-a-stream-to-a-table/ksql.html[*Join a stream and a table*] for a `LEFT JOIN` example. +
