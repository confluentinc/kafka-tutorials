Here are some producer configuration parameters you can set to increase throughput (the values shown are for demonstration purposes, and you will need to further tune these for your environment):
