First, you'll need to create a table to represent click events from users.  Notice that we're intentionally adding some dupliate entries that we'll eventually need to deduplicate.
