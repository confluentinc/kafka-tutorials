////
  ...
  _includes/tutorials/error-handling/kstreams/code/src/main/avro.
...
+++++
<pre class="snippet"><code class="avro">{% include_raw tutorials/error-handling/kstreams/code/src/main/avro/clicks.avsc %}</code></pre>
+++++
