...
For a refresh on scheduling logic using a punctuator, have a look at the link:/tutorials/kafka-streams-schedule-operations/kstreams.html[Scheduling Operations] tutorial.
