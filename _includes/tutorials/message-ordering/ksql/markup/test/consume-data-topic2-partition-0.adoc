...
+++++
<pre class="snippet"><code class="shell">{% include_raw tutorials/message-ordering/ksql/code/test/consume-data-output-partition-0.sh %}</code></pre>
+++++
...
+++++
<pre class="snippet"><code class="text">{% include_raw tutorials/message-ordering/ksql/code/tutorial-steps/test/expected-data-from-topic2-partition-0.sh %}</code></pre>
+++++
