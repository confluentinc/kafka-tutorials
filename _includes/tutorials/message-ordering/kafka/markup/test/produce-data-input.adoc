To produce data into the original Kafka topic `myTopic`, open another terminal window and run the following command to open a second shell on the broker container:
