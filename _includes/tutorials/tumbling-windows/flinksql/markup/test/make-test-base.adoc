...
+++++
<pre class="snippet"><code class="java">{% include_raw tutorials/tumbling-windows/flinksql/code/src/test/java/io/confluent/developer/AbstractFlinkKafkaTest.java %}</code></pre>
+++++
