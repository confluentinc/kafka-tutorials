...
```
ccloud kafka topic consume drama-acting-events --from-beginning --value-format avro
```
...
```
ccloud kafka topic consume fantasy-acting-events --from-beginning --value-format avro
```
...
```
 ccloud kafka topic consume other-acting-events --from-beginning --value-format avro
```
