...
+++++
<pre class="snippet"><code class="java">{% include_raw tutorials/splitting/flinksql/code/src/test/java/io/confluent/developer/AbstractFlinkKafkaTest.java %}</code></pre>
+++++
