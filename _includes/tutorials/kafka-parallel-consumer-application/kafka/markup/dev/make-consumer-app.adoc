...
+++++
<pre class="snippet"><code class="java">{% include_raw tutorials/kafka-parallel-consumer-application/kafka/code/src/main/java/io/confluent/developer/KafkaParallelConsumerApplication.java %}</code></pre>
+++++
